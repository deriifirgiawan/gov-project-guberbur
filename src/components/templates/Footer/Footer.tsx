...
export const Footer = () => {
	...
	return (
		<footer className="bg-green-50  p-4 md:p-8 lg:p-8">
			<section className="w-full flex flex-col md:flex-col lg:flex-row justify-between gap-4 mb-8">
				<div className="md:w-6/12 lg:w-6/12">
					<h4 className="text-xl md:text-3xl mb-4 text-green-600">
						Sekilas Tentang Kami
					</h4>
					<p className="md:mr-[10rem] lg:mr-[10rem] mr-0 mb-4">
						Gubernur.AI memanfaatkan Artificial Intelligence dan big data untuk
					...
					<Button
						variant="outline"
						className="border-2 uppercase border-green-600 hover:border-[#F04279] bg-transparent hover:bg-transparent font-bold text-green-600 hover:text-[#F04279] rounded-full"
					>
						Lebih Lanjut
						<span className="ml-2">
							<MoveRight />
				...
				<div className="md:w-6/12 lg:w-6/12">
					...
					<Button className="bg-green-600 hover:bg-[#F04279] font-bold text-white uppercase">
						kirim
					</Button>
				</div>
			</section>

			<section className="w-full border-t-2 border-t-green-600 pt-4">
				<p>Copyright © 2023 Gubernur.AI - All rights reserved.</p>
